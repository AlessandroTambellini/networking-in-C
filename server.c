...
int main(int argc, char *argv[])
{
    ...
    */
    ...
    /* start listening, listen(socket, backlog). backlog = max num of connections the socket 
    will queue up, each waiting to be accepted */
...
/* NOTES
- sockaddr and sockadd_in have the same size, but they interpret the bits in a different way
- in the networking there's an abuse of casting for addresses and ports. Instead could have been
used union
 */